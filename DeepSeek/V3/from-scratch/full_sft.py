...
def init_model():
    ...
    if model_from == 1:
        ...
        model = AutoModelForCausalLM.from_pretrained('./miniDeepSeek-v1-small', trust_remote_code=True)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="miniDeepSeek Full SFT")
    ...
    parser.add_argument("--wandb_project", type=str, default="miniDeepSeek-Full-SFT", help="Weights & Biases project name")
    ...
    args.wandb_run_name = f"miniDeepSeek-Full-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
